...
// own attempt at sinh and cosh

public static complex sinh(complex z) => 
	Math.Sinh(z.Re)*Math.Cos(z.Im) + complex.I*Math.Cosh(z.Re)*Math.Sin(z.Im);

public static complex cosh(complex z) =>
	Math.Cosh(z.Re)*Math.Cos(z.Im) + complex.I*Math.Sinh(z.Re)*Math.Sin(z.Im);
